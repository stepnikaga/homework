...
//     console.log(`Przed Wami stoi ${str[i].color} ${str[i].model}`);
//   }
// }
// cars(arr3);
...
// }
// emptyArr(arr7);
// console.log(`tablica 6`, arr6);
// console.log(`tablica 7`, arr7);
...
function wordWithY(string) {
  ...
  console.log(
    `W słowie ${string} ${feedback ? "jest litera Y" : "nie ma litery Y"} `
  );
}
wordWithY(word);
wordWithY(word1);
